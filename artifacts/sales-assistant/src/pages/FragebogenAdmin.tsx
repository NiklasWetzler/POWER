...
function parseFormData(fd: Record<string, unknown>) {
  ...
  return {
    ...
    musik:[field("Genres",allGenres.length?allGenres:null),field("Zu vermeiden",fd.vermeiden),field("Lieblingssongs",songs||fd.lieblingssongs),field("Verboten",fd.verboten)].filter(Boolean) as {label:string;display:string}[],
